...
VARIANT_BOOL get_TopLevelContainer()
{
	VARIANT_BOOL result;
...
VARIANT_BOOL get_Visible()
{
	VARIANT_BOOL result;
	InvokeHelper(0x192, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
	return result;
}
void put_Visible(VARIANT_BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
	InvokeHelper(0x192, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
}
VARIANT_BOOL get_StatusBar()
{
	VARIANT_BOOL result;
	InvokeHelper(0x193, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
	return result;
}
void put_StatusBar(VARIANT_BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
